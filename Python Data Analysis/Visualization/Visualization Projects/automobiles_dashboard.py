...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style={'textAlign': 'left', 'color': '#000000', 'font-size': 24}),#Include style for title
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            ...
            names='Vehicle_Type',
            title='Advertising Expenditure by Vehicle during Recession Period'
            )
        )
